"""Django settings for petflowapi project."""
...
WSGI_APPLICATION = "petflowapi.wsgi.application"
...
if os.getenv("DB_ENGINE") == "django.db.backends.postgresql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "petflow"),
            "USER": os.getenv("DB_USER", "petflow"),
